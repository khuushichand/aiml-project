...
import { ChevronDown, Layers, Settings, Globe, Check } from "lucide-react"
      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="inline-flex items-center gap-1 rounded-md border border-border bg-muted px-2.5 py-1.5 text-xs font-medium text-text hover:bg-surface2 transition-colors"
            ...
            >
              <div className="mb-2 flex items-center justify-between px-1">
                ...
                <div className="flex items-center gap-1">
                  <button
                    type="button"
                    className="rounded px-1.5 py-0.5 text-[11px] text-text-muted hover:bg-muted hover:text-text transition-colors"
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        selected ? "bg-primary/10 text-primary" : "hover:bg-muted text-text"
                      )}
                    >
        ...
        <button
          type="button"
          onClick={onOpenSettings}
          className="ml-auto inline-flex items-center gap-1 rounded-md border border-border px-2.5 py-1.5 text-xs text-text-muted hover:bg-muted hover:text-text transition-colors"
        >
