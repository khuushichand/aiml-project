...
export type PlatformTarget = "chrome" | "edge" | "firefox" | "web"
...
export const ALL_TARGETS: PlatformTarget[] = ["chrome", "edge", "firefox", "web"]

const resolveTarget = (): PlatformTarget => {
  const raw = String(env.BROWSER || "web").toLowerCase()
