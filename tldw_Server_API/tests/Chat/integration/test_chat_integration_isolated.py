...
from .conftest_isolated import isolated_db, integration_test_client, mock_server_url, sample_chat_request
...
class TestChatIntegrationIsolated:
    ...
    def test_chat_completion_with_mock_server(self, integration_test_client):
        ...
        response = integration_test_client.post_with_auth("/api/v1/chat/completions", json_data=request_data)
    ...
    def test_conversation_with_mock_server(self, integration_test_client, isolated_db):
        ...
        # Create conversation
        conv_id = isolated_db.create_conversation(user_id="test_user", character_id=1, title="Test Conv")
