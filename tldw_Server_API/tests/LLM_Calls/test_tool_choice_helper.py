...
from tldw_Server_API.app.core.LLM_Calls.providers.base import apply_tool_choice
...
def test_apply_tool_choice_none_when_no_tools_and_no_choice():
    ...
    payload = {}
    apply_tool_choice(payload, tools=None, tool_choice=None)
...
def test_apply_tool_choice_does_not_set_when_no_tools():
    ...
    payload = {}
    apply_tool_choice(payload, tools=None, tool_choice={"type": "function", "function": {"name": "f"}})
    assert "tool_choice" not in payload
...
def test_apply_tool_choice_sets_when_tools_present():
    ...
    apply_tool_choice(payload, tools=[{"type": "function", "function": {"name": "f"}}], tool_choice=tool_choice)
