...
@pytest.mark.asyncio
async def test_get_org_policy_from_principal_does_not_fallback_to_user_memberships(monkeypatch):
    ...
    with pytest.raises(HTTPException) as exc_info:
        await auth_deps.get_org_policy_from_principal(db=None, principal=principal)
