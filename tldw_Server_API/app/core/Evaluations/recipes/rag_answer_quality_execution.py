...
def _resolve_live_retrieval_request(
    *,
    ...
    baseline_metadata = getattr(baseline_record, "metadata", {}) or {}
    baseline_run_config = dict(
        baseline_metadata.get("run_config_internal") or baseline_metadata.get("run_config") or {}
    )
