...
class ChatProviderRegistry:
    ...
    DEFAULT_ADAPTERS: Dict[str, str] = {
        ...
        "moonshot": "tldw_Server_API.app.core.LLM_Calls.providers.compat_adapters.MoonshotAdapter",
        "zai": "tldw_Server_API.app.core.LLM_Calls.providers.compat_adapters.ZaiAdapter",
        "llama.cpp": "tldw_Server_API.app.core.LLM_Calls.providers.compat_adapters.LlamaCppAdapter",
        "kobold": "tldw_Server_API.app.core.LLM_Calls.providers.compat_adapters.KoboldAdapter",
        "ooba": "tldw_Server_API.app.core.LLM_Calls.providers.compat_adapters.OobaAdapter",
        "tabbyapi": "tldw_Server_API.app.core.LLM_Calls.providers.compat_adapters.TabbyAPIAdapter",
        "vllm": "tldw_Server_API.app.core.LLM_Calls.providers.compat_adapters.VLLMAdapter",
        "local-llm": "tldw_Server_API.app.core.LLM_Calls.providers.compat_adapters.LocalLLMAdapter",
        "ollama": "tldw_Server_API.app.core.LLM_Calls.providers.compat_adapters.OllamaAdapter",
        "aphrodite": "tldw_Server_API.app.core.LLM_Calls.providers.compat_adapters.AphroditeAdapter",
    }
