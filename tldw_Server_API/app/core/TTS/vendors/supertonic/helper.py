"""
Vendored Supertonic ONNX helper utilities.

Source: Supertone/supertonic (HF) - simplified for local integration.
"""
...
class TextToSpeech:
    ...
    def __call__(
        ...
        for txt in text_list:
            wav, dur_onnx = self._infer([txt], style, total_step, speed)
            if wav_cat is None:
                wav_cat = wav
                dur_cat = dur_onnx
            else:
