"""
Vendored Supertonic2 ONNX helper utilities.

Source: Supertone/supertonic-2 (HF) - simplified for local integration.
"""
...
class TextToSpeech:
    ...
    def __call__(
        ...
        for txt in text_list:
            wav, dur_onnx = self._infer([txt], [lang], style, total_step, speed)
            if wav_cat is None:
                wav_cat = wav
                dur_cat = dur_onnx
            else:
