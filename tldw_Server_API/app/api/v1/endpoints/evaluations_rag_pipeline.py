...
@pipeline_router.post("/rag/pipeline/presets", response_model=PipelinePresetResponse)
...
@pipeline_router.get("/rag/pipeline/presets", response_model=PipelinePresetListResponse)
...
@pipeline_router.get("/rag/pipeline/presets/{name}", response_model=PipelinePresetResponse)
...
@pipeline_router.delete("/rag/pipeline/presets/{name}", status_code=status.HTTP_204_NO_CONTENT)
...
@pipeline_router.post("/rag/pipeline/cleanup", response_model=PipelineCleanupResponse)
