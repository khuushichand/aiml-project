...
`Tutorial_Per_Page_Coverage.md` design note (`/chat → playground-basics`, `/workspace-playground → workspace-playground-basics`, `/media → media-basics`, and full P0/P1 map).
