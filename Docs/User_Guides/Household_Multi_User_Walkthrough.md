...
> **Companion guide**: For guardrails and parental controls after setup, see [Family_Guardian_Setup.md](Family_Guardian_Setup.md).
...
> **Note**: SQLite multi-user is not supported when `tldw_production=true`. For a home setup this is fine since you won't set that flag. If you later want production mode, switch to Postgres (see [Multi-User_Postgres_Setup.md](Multi-User_Postgres_Setup.md)).
...
And ensure Postgres is running (via Docker or system install). See [Multi-User_Postgres_Setup.md](Multi-User_Postgres_Setup.md) for details.
...
See [BYOK_User_Guide.md](BYOK_User_Guide.md) for details.
...
Virtual keys let you set per-user budgets and model restrictions. See [Family_Guardian_Setup.md](Family_Guardian_Setup.md) for detailed virtual key setup.
...
See [Production_Hardening_Checklist.md](Production_Hardening_Checklist.md) for more details.
...
For automated continuous backups, see [Backups_Using_Litestream.md](Backups_Using_Litestream.md).
...
- [Family_Guardian_Setup.md](Family_Guardian_Setup.md) - Guardrails, virtual keys, and parental controls
- [Authentication_Setup.md](Authentication_Setup.md) - Single-user and multi-user auth overview
- [Multi-User_SQLite_Setup.md](Multi-User_SQLite_Setup.md) - SQLite multi-user technical details
- [Multi-User_Postgres_Setup.md](Multi-User_Postgres_Setup.md) - PostgreSQL AuthNZ setup
- [Multi-User_Deployment_Guide.md](Multi-User_Deployment_Guide.md) - Production multi-user deployment
- [Production_Hardening_Checklist.md](Production_Hardening_Checklist.md) - Security hardening for internet-facing deployments
- [BYOK_User_Guide.md](BYOK_User_Guide.md) - Bring Your Own Key configuration
- [Backups_Using_Litestream.md](Backups_Using_Litestream.md) - Continuous SQLite backup with Litestream
