...
This section is organized by product surface so you can quickly find the right docs:
- **Server**: deployment, authentication, operations, ingestion, RAG, and evaluations.
- **WebUI & Extension**: chat UX, dictation, roleplay, media UX, and user-facing workflows.
...
- [Multi-User Deployment Guide](Server/Multi-User_Deployment_Guide.md)
...
- [Templated Chunking HowTo](Server/Templated_Chunking_Incoming_Documents_HowTo.md)
- [RAG Deployment Guide](Server/RAG_Deployment_Guide.md)
...
- [Context MCP Search](WebUI_Extension/context_mcp_search.md)
...
- [Family Guardian Setup](WebUI_Extension/Family_Guardian_Setup.md)
- [Household Multi-User Walkthrough](WebUI_Extension/Household_Multi_User_Walkthrough.md)
...
- [Setup Supertonic](Integrations_Experiments/Setup-Supertonic.md)
- [Setup Supertonic 2](Integrations_Experiments/Setup-Supertonic2.md)
- [Setting up a local LLM](Integrations_Experiments/Setting_up_a_local_LLM.md)
