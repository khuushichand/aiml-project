...
| `/knowledge` | `knowledge-basics` | P1 |
| `/characters` | `characters-basics` | P1 |
...
1. Prioritize P0 routes where first-run confusion is highest (`/chat`, `/workspace-playground`, `/media`).
