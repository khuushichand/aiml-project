...
## Exit Note
- Stage 2 shared-foundation review is complete. The main confirmed risks are stale pooled-backend lifecycle, backend-level FTS parity drift, and stale-config singleton reuse outside the primary Media DB runtime path.
