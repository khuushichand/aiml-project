...
| 03 | Robert | Mike | 3 | In Progress | Stage 1 baseline artifact + telemetry exports + Group 03 Stage 1/2/3 completion notes + cross-tab relationship jump actions (Activity/Reports/Monitors) + Items handoff regression coverage + focused Runs/Outputs/Items linkage regressions + Bandit stage artifact | UC2 workflow |
