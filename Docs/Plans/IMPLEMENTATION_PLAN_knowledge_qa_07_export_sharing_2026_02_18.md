...
- Shareable-thread URL approach is specified and staged behind permission/access controls (`7.8`).
...
- Routing tests for thread permalink generation/resolve behavior (if enabled).
