...
- Query comparison mode supports side-by-side prior/latest answer comparison with turn selection (`11.9`).
**Tests**:
...
- Component tests for comparison toggle and side-by-side rendering.
**Status**: Complete
